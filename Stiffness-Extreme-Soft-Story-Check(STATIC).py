...
minimum_lateral_stiffness_proportion_70percent = [0.60,0.60,0.60,0.60,0.60,0.60,0.60,0.60,0.60,0.60,0.60,0.60,0.60,0.00,0.00]
minimum_lateral_stiffness_proportion_80percent = [0.7,0.7,0.7,0.7,0.7,0.7,0.7,0.7,0.7,0.7,0.7,0.7,0.00,0.00,0.00]
...
plt.plot(stiffness_proportion_of_two_stories,story_level,label="story stiffness proportion of 70%(X-dir)",marker = "^",color="gold",markersize=5,linewidth=2)
plt.plot(stiffness_proportion_of_four_stories,story_level,label="story stiffness proportion of 80%(X-dir)",marker = "D",color="turquoise",markersize=5,linewidth=2)
plt.plot(stiffness_proportion_of_two_stories,story_level,label="story stiffness proportion of 70%(Y-dir)",marker = "^", color="royalblue",markersize=5,linewidth=2)
plt.plot(stiffness_proportion_of_four_stories,story_level,label="story stiffness proportion of 80%(Y-dir)",marker = "D", color="limegreen",markersize=5,linewidth=2)
